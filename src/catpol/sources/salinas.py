...
"""Fetch Salinas ordinances/resolutions from HuggingFace."""
...
def fetch_salinas_ordinances(
    n: int | None = None,
    doc_type: str | None = None,
    since: str | None = None,
    until: str | None = None,
    repo_id: str = "chrissoria/salinas-ordinances",
) -> pd.DataFrame:
    """Load Salinas ordinances/resolutions from HuggingFace and return a filtered DataFrame.
